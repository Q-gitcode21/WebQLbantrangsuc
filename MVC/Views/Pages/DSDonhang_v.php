    ...
    <main class="table" id="customers_table">
        ...
        <section class="table__body">
            <table>
                <thead>
                    <tr>
                        <th> Mã Khách Hàng <span class="icon-arrow">&UpArrow;</span></th>
                        ...
                        <th> Voucher <span class="icon-arrow">&UpArrow;</span></th>
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <form action="http://localhost/Web%20qu%E1%BA%A3n%20l%C3%BD/DSDonhang/sua/<?php echo $row['Madonhang']?>" method="post">
                                               ...
                                               <form action="http://localhost/Web%20qu%E1%BA%A3n%20l%C3%BD/DSDonhang/xoa/<?php echo $row['Madonhang']?>" method="post">
