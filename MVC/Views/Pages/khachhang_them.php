    ...
    <div class="form-box login">
            ...
            <form action="#">
                ...
                <div class="input-box">
                    ...
                    <input type="text" required name="txtmakhachhang" value="<?php if(isset($data['MaKH'])) echo $data['MaKH']?>">
                    <label>Mã KH</label>
                </div>            
                <div class="input-box">
                    <span class="icon">
                ...
                <br>
                <div class="quaylai">
                <a href="http://localhost/Web%20qu%E1%BA%A3n%20l%C3%BD/DSkhachhang">Quay lại</a>
                </div>
